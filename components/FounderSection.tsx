...
const FounderSection: React.FC = () => {
  return (
    <section
      id="founder"
      className="py-24 md:py-48 px-8 md:px-16 lg:px-24 bg-[#F6F3EE] overflow-hidden"
    >
          ...
          <div className="reveal-on-scroll relative group">
            <div className="relative z-10 aspect-[4/5] rounded-[2rem] md:rounded-[3rem] overflow-hidden bg-white shadow-2xl shadow-black/5">
              <img
                ...
                className="w-full h-full object-cover grayscale-[15%] hover:grayscale-0 transition-all duration-[1200ms] ease-out group-hover:scale-[1.05]"
              />
            </div>
            ...
            <div className="absolute top-12 -right-4 bg-[#C6A75E] text-white px-6 py-2 rotate-90 origin-right rounded-sm shadow-lg">
              <p className="text-[8px] uppercase tracking-[0.4em] font-bold whitespace-nowrap">
                Est. 2014
              </p>
            </div>
          </div>
          ...
          <div className="reveal-on-scroll delay-200 space-y-12">
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                <span className="h-[1px] bg-[#C6A75E] w-12 draw-line reveal-on-scroll"></span>
              ...
              <div className="space-y-4 overflow-hidden">
                ...
                <p
                  className="text-sm md:text-base uppercase tracking-[0.3em] text-[#C6A75E] font-medium text-reveal-up"
            ...
            <div className="space-y-8">
              <div className="overflow-hidden">
                <p
                  className="text-[#1E1E1E]/80 font-light text-xl leading-relaxed max-w-xl text-reveal-up"
                  style={{ transitionDelay: '0.4s' }}
                >
                  “With an eye for timeless elegance and a passion for refined craftsmanship,
                  Chandni founded SBC Design Concept to create interiors that feel personal,
                  purposeful, and enduring. Each space is thoughtfully curated to balance
                  luxury, comfort, and architectural harmony.”
                </p>
              </div>

              {/* Instagram Link */}
              <div
                className="pt-2 reveal-on-scroll"
            ...
            {/* CTA + Email */}
            <div
              className="pt-6 flex flex-col sm:flex-row items-start sm:items-center gap-12 reveal-on-scroll"
            ...
            >
              <button className="group relative px-12 py-5 bg-[#1E1E1E] text-white overflow-hidden rounded-full transition-all duration-700 hover:scale-[1.05] hover:bg-[#C6A75E] shadow-xl shadow-black/10">
                <span className="relative z-10 text-[10px] uppercase tracking-[0.4em] font-bold">
                  Meet the Founder
                </span>
              ...
              <div className="flex flex-col">
                <p className="text-[10px] uppercase tracking-[0.3em] font-bold text-[#C6A75E]">
                  Enquiries
                </p>
                <a
                  href="mailto:stylebychandni@gmail.com"
                  className="text-sm font-light border-b border-[#1E1E1E]/10 hover:border-[#C6A75E] transition-all py-1"
                >
